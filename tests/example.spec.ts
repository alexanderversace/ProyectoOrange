...
test('ORANGE', async ({ page }) => {
  ...
  await page.click('#app > div.oxd-layout > div.oxd-layout-navigation > aside > nav > div.oxd-sidepanel-body > ul > li:nth-child(1) > a > span');
   ...
   // Esperar a que la página de gestión de usuarios cargue y darle click al boton agregar
  ...
  await page.click('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div.orangehrm-paper-container > div.orangehrm-header-container > button');
    ...
    // Interactuar con el dropdown de Status
  ...
  await page.fill('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div:nth-child(1) > div > div:nth-child(2) > div > div:nth-child(2) > div > div > input', 'Alexander bravo carpio');
  
  // Esperar que la lista de autocompletado aparezca y seleccionar el primer resultado
  ...
  await page.fill('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div:nth-child(1) > div > div:nth-child(4) > div > div:nth-child(2) > input', 'FELIX DEL CARPIANO');
    // Interactuar con el dropdown de Status
  ...
  await page.fill('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div.oxd-form-row.user-password-row > div > div.oxd-grid-item.oxd-grid-item--gutters.user-password-cell > div > div:nth-child(2) > input', 'Admin123');
  await page.fill('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > form > div.oxd-form-row.user-password-row > div > div:nth-child(2) > div > div:nth-child(2) > input', 'Admin123');
